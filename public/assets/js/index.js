...
$(document).ready(function() {
    ...
    function renderEmpty() {
        ...
        // Using a joined array of HTML string data because it's easier to read/change than a c
        // concatenated string
        var emptyAlert = 
          $([
              "<div class='alert alert-warning text-center'>",
              "<h4>Uh Oh. Looks likewe don't have any new articles.</h4>",
              "</div>",
              "<div class='panel panel-default'>",
    ...
    function handleArticleSave() {
        ...
        // headline id
        // to the element using the .data meathod. We retrieve that here.
    ...
    function handleArticleScrape() {
        ...
        $.get("/api/fetch")
        .then(function(data) {
            // If able to successfully scrape the NYTimes and compare the articles to those
            // already in our collection, re render the articles on the page
            // let the user know how many unique articles are able to be saved
            initPage();
